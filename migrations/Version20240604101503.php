 ...
 */
final class Version20240604101503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE conference (id INT NOT NULL, city VARCHAR(255) NOT NULL, year VARCHAR(4) NOT NULL, is_international BOOLEAN NOT NULL, slug VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_911533C82D5B0234 ON conference (city)');
        $this->addSql('CREATE TABLE product (id INT NOT NULL, product_category_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, price INT NOT NULL, description TEXT NOT NULL, PRIMARY KEY(id))');
